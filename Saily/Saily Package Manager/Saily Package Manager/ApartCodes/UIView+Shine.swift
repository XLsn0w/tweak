...
fileprivate let kTransform = "transform"
fileprivate let kStrokeStart = "strokeStart"
fileprivate let kStrokeEnd = "strokeEnd"
fileprivate let kOpacity = "opacity"

fileprivate class PPShineLayer: CAShapeLayer {
...
extension UIView {
    ...
    fileprivate func creatNewSubLayers(with duration: TimeInterval = 1.0) {
        ...
        let lineFrame = CGRect(x: imageFrame.origin.x - imageFrame.width / 4, y: imageFrame.origin.y - imageFrame.height / 4 , width: imageFrame.width * 1.8, height: imageFrame.height * 1.8)
        ...
        circleShape.fillColor = UIColor.random.cgColor
        ...
        imageShape.fillColor = UIColor.blue.cgColor
